...
CREATE TABLE fe_users (
	...
	tx_seminars_matriculation_number int(11) DEFAULT '0' NOT NULL,
	tx_seminars_planned_degree tinytext NOT NULL,
	tx_seminars_semester int(11) DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_seminars_seminars (
	...
	attendees_max int(11) DEFAULT '0' NOT NULL,
	cancelled tinyint(3) unsigned DEFAULT '0' NOT NULL,
	attendees int(11) DEFAULT '0' NOT NULL,
