...
/**
 * Class 'tx_seminars_Model_Checkbox' for the 'seminars' extension.
 *
 ...
 */
class tx_seminars_Model_Checkbox extends tx_oelib_Model {
	/**
	 * Returns our title.
	 *
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/seminars/Model/class.tx_seminars_Model_Checkbox.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/seminars/Model/class.tx_seminars_Model_Checkbox.php']);
}
?>