...
class Tx_Seminars_Tests_Unit_OldModel_EventTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->subject = new \Tx_Seminars_Tests_Unit_Fixtures_OldModel_TestingEvent(
            $uid,
            [
                'dateFormatYMD' => '%d.%m.%Y',
                'timeFormat' => '%H:%M',
    ...
    {
        $this->subject->setBeginDate($this->beginDate);
        self::assertSame(
            $this->beginDate,
            $this->subject->getBeginDateAsTimestamp()
        );
    ...
    {
        $this->subject->setEndDate($this->beginDate);
        self::assertSame(
            $this->beginDate,
            $this->subject->getEndDateAsTimestamp()
        );
    ...
    public function getAttachedFilesInitiallyReturnsAnEmptyArray()
    {
        ...
        self::assertSame(
            [],
            $this->subject->getAttachedFiles($this->pi1)
        );
    }
    ...
    public function getAttachedFilesWithOneSetAttachedFileReturnsAttachedFileAsArrayWithCorrectFileSize()
    {
        ...
        $this->subject->setAttachedFiles($dummyFileName);
    ...
    public function updatePlaceRelationsForSeminarWithoutPlacesRelatesPlaceFromTimeslotToSeminar()
    {
        ...
        $this->subject->setNumberOfTimeSlots(1);

        self::assertSame(
            1,
            $this->subject->updatePlaceRelationsFromTimeSlots()
        );
    }
    ...
    public function updatePlaceRelationsForTwoTimeslotsWithPlacesReturnsTwo()
    {
        ...
        $this->subject->setNumberOfTimeSlots(2);
    ...
    public function getLatestPossibleRegistrationTimeForEventWithBeginAndEndDateAndRegistrationForStartedEventsAllowedReturnsEndDate(
        ...
        $subject = new \Tx_Seminars_Tests_Unit_Fixtures_OldModel_TestingEvent(
            $uid,
    ...
    {
        $this->subject->setOfflineRegistrationNumber(2);
    ...
    public function calculateStatisticsForEventWithOfflineRegistrationsAndRegularRegistrationsCalculatesCumulatedAttendeeNumber(
        ...
        $this->subject->calculateStatistics();

        self::assertSame(
            2,
            $this->subject->getAttendances()
        );
    }
    ...
    public function calculateStatisticsForEventWithOnePaidRegistrationSetsOnePaidAttendance()
    {
        ...
        self::assertSame(
            1,
            $this->subject->getAttendancesPaid()
        );
    }
