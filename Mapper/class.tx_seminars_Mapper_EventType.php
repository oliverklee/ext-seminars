...
class tx_seminars_Mapper_EventType extends tx_oelib_DataMapper {
	 ...
	 */
	protected $tableName = SEMINARS_TABLE_EVENT_TYPES;
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/seminars/Mapper/class.tx_seminars_Mapper_EventType.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/seminars/Mapper/class.tx_seminars_Mapper_EventType.php']);
}
?>