...
$EM_CONF[$_EXTKEY] = [
    ...
    'description' => 'Allows you to create and manage a list of seminars, workshops, lectures, theater performances and other events, allowing front-end users to sign up.',
    'version' => '5.7.0',
    'category' => 'plugin',
    'constraints' => [
        'depends' => [
