    ...
    'columns' => [
        ...
        'categories' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_categories.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'event_type' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_event_types.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'default' => 0,
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
        ...
        'lodgings' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_lodgings.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'foods' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_foods.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'speakers' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_speakers.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'payment_methods' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_payment_methods.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'size' => 5,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'organizers' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_organizers.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'size' => 5,
                'minitems' => 1,
                'maxitems' => 999,
        ...
        'organizing_partners' => [
            ...
            'config' => [
                ...
                'allowed' => 'tx_seminars_organizers',
                'foreign_table' => 'tx_seminars_organizers',
                'foreign_table_where' => 'AND tx_seminars_organizing_partners.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'target_groups' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_target_groups.pid LIKE ###PAGE_TSCONFIG_STR### ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
