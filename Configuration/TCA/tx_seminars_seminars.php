    ...
    'columns' => [
        ...
        'categories' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_categories.pid LIKE ###TCA-CATEGORIES-PID###  ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'event_type' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND  tx_seminars_event_types.pid LIKE ###TCA-EVENTS-PID###  ORDER BY title',
                'default' => 0,
                'size' => 1,
                'minitems' => 0,
                'maxitems' => 1,
        ...
        'place' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND tx_seminars_sites.pid LIKE ###TCA-SITES-PID###  ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'lodgings' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => '  AND  tx_seminars_lodgings.pid LIKE ###TCA-LODGINGS-PID###  ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'foods' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND  tx_seminars_foods.pid LIKE ###TCA-FOODS-PID###  ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'speakers' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND  tx_seminars_speakers.pid LIKE ###TCA-SPEAKERS-PID###  ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'checkboxes' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_checkboxes.pid LIKE ###TCA-CHECKBOXES-PID###  ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'payment_methods' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND  tx_seminars_payment_methods.pid LIKE ###TCA-PAYMENT-METHODS-PID###  ORDER BY title',
                'size' => 5,
                'minitems' => 0,
                'maxitems' => 999,
        ...
        'organizers' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => ' AND  tx_seminars_organizers.pid LIKE ###TCA-ORGANIZERS-PID###  ORDER BY title',
                'size' => 5,
                'minitems' => 1,
                'maxitems' => 999,
        ...
        'target_groups' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_seminars_categories.pid LIKE ###TCA-TAGRGET-GROUPS-PID###  ORDER BY title',
                'size' => 10,
                'minitems' => 0,
                'maxitems' => 999,
