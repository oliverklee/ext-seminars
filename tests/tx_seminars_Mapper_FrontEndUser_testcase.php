...
/**
 * Testcase for the tx_seminars_Mapper_FrontEndUser class in the 'seminars' extension.
 *
 * @package TYPO3
 ...
 */
class tx_seminars_Mapper_FrontEndUser_testcase extends tx_phpunit_testcase {
	/**
