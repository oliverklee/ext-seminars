...
/**
 * Testing version of tx_seminars_BackEndExtJs_Ajax_EventsList for the
 * "seminars" extension.
 *
 ...
 */
class tx_seminars_tests_fixtures_BackEndExtJs_Ajax_TestingEventsList extends tx_seminars_BackEndExtJs_Ajax_EventsList {
	/**
