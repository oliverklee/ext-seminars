...
/**
 * Testcase for the 'abstract time-span model' class in the 'seminars' extension.
 *
 * @package TYPO3
 ...
 */
class tx_seminars_Model_AbstractTimeSpan_testcase extends tx_phpunit_testcase {
	/**
